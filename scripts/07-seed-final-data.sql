...
VALUES
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'FeedMaster Supplies', 'supplier', 'John Smith', 'john@feedmaster.com', '+1-555-0101', '123 Farm Road, Iowa', 'Primary feed supplier, 10% bulk discount', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'VetCare Clinic', 'supplier', 'Dr. Sarah Johnson', 'sarah@vetcare.com', '+1-555-0102', '456 Medical Ave, Iowa', 'Emergency services available 24/7', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'PoultryMart Wholesale', 'customer', 'Mike Chen', 'mike@poultrymart.com', '+1-555-0103', '789 Commerce St, Chicago', 'Weekly bulk purchases, payment net-30', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'Farm Equipment Co', 'supplier', 'Lisa Brown', 'lisa@farmequip.com', '+1-555-0104', '321 Industrial Blvd, Iowa', 'Maintenance contracts available', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'BioHealth Pharmaceuticals', 'supplier', 'Dr. Robert Lee', 'robert@biohealth.com', '+1-555-0105', '654 Science Park, Boston', 'Vaccines and medications supplier', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'Local Farmers Market', 'customer', 'Emma Wilson', 'emma@farmersmarket.com', '+1-555-0106', '987 Market Square, Iowa', 'Retail sales, premium prices', NOW(), NOW());

-- Insert Employees
INSERT INTO employees (id, user_id, name, position, email, phone, hire_date, salary, status, notes, created_at, updated_at)
VALUES
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'James Anderson', 'Farm Manager', 'james@farm.com', '+1-555-0201', '2022-01-15', 55000, 'active', 'Experienced in poultry management, 10 years experience', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'Maria Garcia', 'Veterinary Technician', 'maria@farm.com', '+1-555-0202', '2022-03-20', 45000, 'active', 'Licensed vet tech, handles all health checks', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'David Kim', 'Production Supervisor', 'david@farm.com', '+1-555-0203', '2022-06-01', 42000, 'active', 'Oversees daily egg collection and quality control', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'Jennifer Taylor', 'Feed Specialist', 'jennifer@farm.com', '+1-555-0204', '2023-01-10', 38000, 'active', 'Manages feed inventory and nutrition programs', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'Carlos Rodriguez', 'Maintenance Worker', 'carlos@farm.com', '+1-555-0205', '2023-04-15', 35000, 'active', 'Handles facility maintenance and repairs', NOW(), NOW()),
  (gen_random_uuid(), '26d5530c-da7c-4076-9305-db5bcc2980dc', 'Amy Chen', 'Sales Coordinator', 'amy@farm.com', '+1-555-0206', '2023-08-01', 40000, 'active', 'Manages customer relationships and orders', NOW(), NOW());
...
SELECT 
  gen_random_uuid(),
  '26d5530c-da7c-4076-9305-db5bcc2980dc',
  'chicken',
  CASE (random() * 3)::int
  ...
  CASE (random() * 10)::int
    WHEN 0 THEN 'sick'::animal_status
    WHEN 1 THEN 'quarantine'::animal_status
    ELSE 'healthy'::animal_status
  END,
...
SELECT 
  ...
  CASE (random() * 3)::int
    ...
    WHEN 1 THEN 'credit'::payment_method
  ...
  (SELECT id FROM vendors WHERE vendor_type = 'customer' LIMIT 1),
  'Regular customer',
  NOW(),
  NOW()
...
SELECT 
  ...
  '26d5530c-da7c-4076-9305-db5bcc2980dc',
  CASE (random() * 7)::int
    WHEN 0 THEN 'feed'::expense_category
    WHEN 1 THEN 'veterinary'::expense_category
    WHEN 2 THEN 'utilities'::expense_category
    WHEN 3 THEN 'maintenance'::expense_category
    WHEN 4 THEN 'labor'::expense_category
    WHEN 5 THEN 'transport'::expense_category
...
SELECT 
  ...
  '26d5530c-da7c-4076-9305-db5bcc2980dc',
  CASE (random() * 3)::int
    WHEN 0 THEN 'product_sales'::income_source
    WHEN 1 THEN 'product_sales'::income_source
    ELSE 'other'::income_source
  END,
  CURRENT_DATE - (random() * 90)::int,
